 ...
 */
nimbus::Tile::Tile(unsigned int type, float humidity, float temperature, float saturation): type(type), humidity(humidity), temperature(temperature), saturation(saturation) { this->count++; }
